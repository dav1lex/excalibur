<div class="row mb-4">
    <div class="col-md-12">
        <div class="d-flex justify-content-between align-items-center mb-3 border-bottom pb-2">
            <h1 class="display-5 mb-0">Edit Lot</h1>
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <form action="<?= BASE_URL ?>lots/update/<?= $lot['id'] ?>" method="post"
                        ...
                        <div class="mb-3">
                            <label for="lot_number" class="form-label">Lot Number <span
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="lot_number" name="lot_number"
                                    pattern="[0-9]{1,3}" maxlength="3" value="<?= htmlspecialchars($numericPart) ?>"
                                    required>
                            </div>
                        ...
                        <div class="mb-3">
                            <label for="image" class="form-label">Update Image <small
                                    class="text-muted">(Optional)</small></label>
                            <input type="file" class="form-control" id="image" name="image"
                                accept="image/jpeg, image/png">
                            <div class="form-text">Max file size: 6MB. Allowed formats: JPG, PNG. Leave empty to keep
                                current image.</div>
                        </div>
                            ...
                            <?php foreach ($bids as $bid): ?>
                                <li class="list-group-item">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <small
                                            class="text-muted"><?= date('M j, Y, g:i A', strtotime($bid['created_at'])) ?></small>
                                    </div>
                                </li>
                            <?php endforeach; ?>
                        </ul>
