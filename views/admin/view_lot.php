<div class="row mb-4">
    <div class="col-md-12">
        <div class="d-flex justify-content-between align-items-center mb-3 border-bottom pb-2">
            <h1 class="display-5 mb-0">Lot Details</h1>
                        ...
                        <div class="col-md-5">
                            <?php if (!empty($lot['image_path'])): ?>
                                <img src="<?= BASE_URL . htmlspecialchars($lot['image_path']) ?>"
                                    class="img-fluid rounded shadow-sm" alt="<?= htmlspecialchars($lot['title']) ?>">
                            <?php else: ?>
                        ...
                        <div class="col-md-7">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-7 fw-bold text-primary">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-7"><?= date('M j, Y, g:i A', strtotime($lot['updated_at'])) ?>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Are you sure you want to delete the lot "<?= htmlspecialchars($lot['title']) ?>"? This action cannot
                    be undone.
                </div>
